...
for(i in names(models_list)){
  ...
  probabilities110 <- models_list[[i]] %>% predict(day110_gene_expression_data, type = "response") 
  probabilities94 <- models_list[[i]] %>% predict(day94_gene_expression_data, type = "response") 
